...
// Aspect-aware flat-lay, shared by the Style and Saved pages.
// Extracted verbatim from the Style page so both render identically.
...
export function FlatLay({ outfit, idx = 0 }) {
